...
public class DataSetters {
    public static byte [] setErrorCorrection(int id, Vector2 position, Vector2 destination){
        ...
        byte [] des = ByteFunctions.concat(desX,desY);
        byte [] pos = ByteFunctions.concat(posX,posY);
        byte [] data = ByteFunctions.concat(dataType,pos);
        byte [] dataToSend = ByteFunctions.concat(data,des);
        return dataToSend;
    }
    public static byte [] setCollisionData(int id, Vector2 newDestination){
        ...
        byte [] destination = ByteFunctions.concat(posX,posY);
        byte [] dataToSend = ByteFunctions.concat(dataType,destination);
        return dataToSend;
    }
    ...
    public static byte [] setHitData(int id, int health){
        ...
        byte [] dataToSend = ByteFunctions.concat(dataType,healthBytes);
        return dataToSend;
    }
    public static byte [] setBulletData(Vector2 velocity)
    {
        ...
        byte [] velocityBytes = ByteFunctions.concat(posX,posY);
        byte [] dataToSend = ByteFunctions.concat(dataType,velocityBytes);
        return dataToSend;
    }
    public static byte [] setBulletData(int id, byte [] velocity)
    {
        byte [] dataType = { (byte) DataType.SHOOT.getId(), (byte) id};
        byte [] dataToSend = ByteFunctions.concat(dataType,velocity);
        return dataToSend;
    }
    ...
    public static byte [] setEnemyData(int id, int x, int y){
        ...
        byte [] position = ByteFunctions.concat(posX,posY);
        byte [] dataToSend = ByteFunctions.concat(dataType,position);
        return dataToSend;
    }
    ...
    public static byte [] setNameData(String name){
        ...
        byte [] dataToSend = ByteFunctions.concat(dataType,name.getBytes());
        return dataToSend;
    }
    public static byte [] setNameData(int id, byte [] name){
        byte [] dataType = { (byte) DataType.NAME.getId(), (byte) id};
        byte [] dataToSend = ByteFunctions.concat(dataType,name);
        return dataToSend;
    }
    ...
    public static byte [] createMsg(int id, byte [] msg){
        ...
        byte [] dataToSend = ByteFunctions.concat(dataType,msg);
        return dataToSend;
    }
}
